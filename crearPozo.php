            ...
            <form class="col s12" action="creandoPozo.php" method="post">
                <div class="row">
                    <div class="input-field col s6">
                        ...
                        <label class="light-blue-text text-darken-4" for="input_text">Nombre del pozo:</label>
                    </div>
                </div>
                
                <button class="btn waves-effect waves-light light-blue darken-4" type="submit" name="action">Añadir pozo</button>
            </form>
        </div>
    </div>
